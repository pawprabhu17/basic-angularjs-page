...
app.controller('appController',['$scope',function($scope){
	...
	$scope.removeProtea = function(x){
		var removedProtea= $scope.protea.indexOf(x); //index of the element to be removed
		$scope.protea.splice(removedProtea,1); //removes the element of that index and 1 is the number of element to be removed
	};
